...
-- irum필드를 name필드로 수정하시오? 길이는 가변문자형(20)
...
select name as 이름, gender '성별', jikwi '직위', address '주소' from insarok;
...
select name,gender,age,address from insarok where gender='여자' and age between 20 and 29;

-- 성별이 여자인 20대 직원중 '성명', '성별', '나이', '주소'만 보여주시오?(필드명을 한글로 표시하시오)
select name '이름',gender '성별',age '나이',address '주소' from insarok where gender='여자' and age between 20 and 29;
...
insert into insarok (name, jikwi, buser) values ('길길무', '과장', '인사과');
